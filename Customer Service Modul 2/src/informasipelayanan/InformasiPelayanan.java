...
public class InformasiPelayanan {
    ...
    static void loginPelanggan() {
        ...
        try {
            ...
            System.out.println("Selamat Datang " + dataPelanggan.PelangganArrayList(cek).getNama());
            dataPelanggan.view();
            Pelayanan();
        }catch ( Exception err ) {
            System.out.println( "Data anda belum terdaftar " + err.getMessage( ) );
        }
    }
    ...
    static void loginPetugas() {
        ...
        dataPetugas.view();
        try {
            System.out.println("Selamat Datang " + dataPetugas.PetugasArrayList(cek).getNama());
            dataPelanggan.view();
        }catch ( Exception err ) {
            System.out.println( "Data anda belum terdaftar " + err.getMessage( ) );
        }
